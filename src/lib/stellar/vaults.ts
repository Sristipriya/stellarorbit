...
export const VAULTS: VaultMeta[] = [
  {
    ...
    assetSymbol: "XLM",
    contractId: ORBIT_VAULT_CONTRACT_ID || import.meta.env.VITE_ORBIT_VAULT_CONTRACT_ID,
    assetId: XLM_SAC,
    trancheId: ORBIT_TRANCHE_CONTRACT_ID || import.meta.env.VITE_ORBIT_TRANCHE_CONTRACT_ID,
    marketId: ORBIT_MARKET_CONTRACT_ID || import.meta.env.VITE_ORBIT_MARKET_CONTRACT_ID,
    ptId: ORBIT_PT_TOKEN_ID || import.meta.env.VITE_ORBIT_PT_TOKEN_ID,
    ytId: ORBIT_YT_TOKEN_ID || import.meta.env.VITE_ORBIT_YT_TOKEN_ID,
