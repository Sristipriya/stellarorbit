...
export function DepositCard({ address, state, walletBalance, onDone }: { address: string | null; state: VaultState; walletBalance: string | null; onDone: () => void }) {
  ...
  return (
    <div className="glass rounded-2xl p-5">
      ...
      <div className="mt-2 flex justify-between font-mono text-[11px] text-[var(--orbit-mute)]">
        <span>You'll receive ≈ <span className="text-[var(--orbit-accent)]">{stroopsToXlm(previewShares)} shares</span></span>
