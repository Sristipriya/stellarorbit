  ...
  return (
    <div className="brutalist-card rounded-2xl p-5">
      ...
      <div className="mt-2 flex justify-between font-mono text-[11px] text-[var(--orbit-mute)]">
        <span>
          You'll receive ≈{" "}
          <span className="text-[var(--orbit-accent)]">{stroopsToXlm(previewAssets)} XLM</span>
        </span>
      ...
      <button
        ...
        className="brutalist-button mt-4 w-full justify-center transition-all hover:brightness-110"
        style={{
          background:
